...
class UpdateSinger extends Component {
    ...
    postDataHandler = () => {
        ...
        axios.post(`http://localhost:9008/api/v1/update/singer`, data)
            .then(response => {
    ...
    render() {
        return (
            <Aux>
                <Card>
                    <Card.Header>Update Singer</Card.Header>
                    <Card.Body>
                        <Form 
                            {...layout}
                        ...
                        >
                            ...
                            >
                                <Input placeholder="Enter Singer ID" value={this.state.id} onChange={(event) => this.setState({id: event.target.value})} />
                            </Form.Item>
                            <Form.Item
                                label="Singer Name : "
                                name="name"
