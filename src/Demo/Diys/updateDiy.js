...
class UpdateDiy extends Component {
    ...
    postDataHandler = () => {
        ...
        axios.post(`http://localhost:9008/api/v1/update/diy`, data)
            .then(response => {
    ...
    render() {
        return (
            <Aux>
                <Card>
                    <Card.Header>Update DIY</Card.Header>
                    <Card.Body>
                        <Form 
                            {...layout}
                        ...
                        >
                            <Form.Item 
                                name="id" 
                                label="ID : " 
                                rules={[{ required: true, message: 'Missing DIY ID' }]}
                            >
                                <Input placeholder="Enter DIY ID" value={this.state.id} onChange={(event) => this.setState({id: event.target.value})} />
                            </Form.Item>
                            <Form.Item 
                                name="img" 
                                label="Image : " 
